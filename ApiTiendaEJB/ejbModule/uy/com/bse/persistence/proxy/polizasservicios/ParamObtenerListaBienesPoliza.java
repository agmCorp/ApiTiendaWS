...
/**
 * <p>Clase Java para paramObtenerListaBienesPoliza complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="paramObtenerListaBienesPoliza">
 *   &lt;complexContent>
 *     &lt;extension base="{http://ws.polizas.bse.com.uy/}paramGenerico">
 *       &lt;sequence>
 *         &lt;element name="codBienAsegurado" type="{http://www.w3.org/2001/XMLSchema}string"/>
 ...
 *         &lt;element name="numConsecutivoBienAsegurado" type="{http://www.w3.org/2001/XMLSchema}string"/>
...
@XmlType(name = "paramObtenerListaBienesPoliza", propOrder = {
    "codBienAsegurado",
    "codRamo",
    "numCertificado",
    "numConsecutivoBienAsegurado",
    "numEndoso",
    "numPoliza"
})
public class ParamObtenerListaBienesPoliza
    extends ParamGenerico
{

    @XmlElement(required = true, nillable = true)
    protected String codBienAsegurado;
    @XmlElement(required = true, nillable = true)
    protected String codRamo;
    @XmlElement(required = true, nillable = true)
    protected String numCertificado;
    @XmlElement(required = true, nillable = true)
    protected String numConsecutivoBienAsegurado;
    @XmlElement(required = true, nillable = true)
     ...
     *     
     */
    public void setCodBienAsegurado(String value) {
    ...
    /**
     * Obtiene el valor de la propiedad numConsecutivoBienAsegurado.
     * 
     * @return
     *     possible object is
     *     {@link String }
    ...
    /**
     * Define el valor de la propiedad numConsecutivoBienAsegurado.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setNumConsecutivoBienAsegurado(String value) {
        this.numConsecutivoBienAsegurado = value;
    }
